...
const moduleMap = {'vue':{get:()=>()=>__federation_import(new URL('__federation_shared_vue-BYFLC1rq.js', import.meta.url).href),import:true,requiredVersion:'^3.4.0'},'vue-router':{get:()=>()=>__federation_import(new URL('__federation_shared_vue-router-DfXMlFg3.js', import.meta.url).href),import:true,requiredVersion:'^4.3.0'},'element-plus':{get:()=>()=>__federation_import(new URL('__federation_shared_element-plus-C2ERfn5w.js', import.meta.url).href),import:true,requiredVersion:'^2.6.0'}};
